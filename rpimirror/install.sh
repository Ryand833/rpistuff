...
cd /usr/local/bin/
wget "https://github.com/Ryand833/rpistuff/releases/download/v0.2/buttonboot.py"
chmod 0755 buttonboot.py
cd /lib/systemd/system/
wget "https://github.com/Ryand833/rpistuff/releases/download/v0.2/buttonboot.service"
